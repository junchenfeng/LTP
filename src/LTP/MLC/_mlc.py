...
single_component_data_path = (
    test_data_dir + "/data/test/single_component_complete_track.txt"
)
double_component_data_path = (
    test_data_dir + "/data/test/double_component_complete_track.txt"
)
single_component_incom_data_path = (
    test_data_dir + "/data/test/single_component_incomplete_track.txt"
)
double_component_incom_data_path = (
    test_data_dir + "/data/test/double_component_incomplete_track.txt"
)
...
res = test_instance.solve()
# print result
true_param = np.array([[0.2, 0.4, 0.6, 0.8, 0.9], [0.8, 0.8, 0.8, 0.8, 0.8]]).reshape(
    2, 5
)
