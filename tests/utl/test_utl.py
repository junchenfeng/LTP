...
class TestAssembly(unittest.TestCase):
    def setUp(self):
        self.response_dict = {1: 0, 2: 0, 3: 0}
    ...
    def test_Z(self):
        ...
        true_z = np.array([0.2*0.75*0.5*0.25/sum_z, 0.8*0.9*0.8*0.7/sum_z]).reshape(2,1)
    ...
    def test_mixture_update(self):
        ...
        ps = utl.update_mixture_density({1:self.response_dict,2:self.response_dict},
